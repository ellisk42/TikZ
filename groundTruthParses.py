...
groundTruth['drawings/expert-23.png'] = set(['Circle(center = (2,14), radius = 1)', 'Circle(center = (10,10), radius = 1)', 'Line((10,11), (10,13), arrow = True, solid = True)', 'Circle(center = (6,10), radius = 1)', 'Line((9,10), (7,10), arrow = True, solid = True)', 'Line((6,11), (6,13), arrow = True, solid = True)', 'Circle(center = (10,14), radius = 1)', 'Circle(center = (6,14), radius = 1)', 'Line((2,11), (2,13), arrow = True, solid = True)', 'Line((5,10), (3,10), arrow = True, solid = True)', 'Circle(center = (2,10), radius = 1)'])
...
groundTruth['drawings/expert-29.png'] = set(['Line((2,15), (4,15), arrow = False, solid = True)', 'Line((4,9), (4,13), arrow = False, solid = True)', 'Line((3,11), (3,14), arrow = False, solid = True)', 'Line((2,13), (2,15), arrow = False, solid = True)', 'Line((3,14), (6,14), arrow = False, solid = True)', 'Line((4,13), (8,13), arrow = False, solid = True)'])
...
groundTruth['drawings/expert-33.png'] = set(['Line((8,11), (8,14), arrow = False, solid = True)', 'Line((2,14), (8,14), arrow = False, solid = False)', 'Line((2,11), (8,11), arrow = False, solid = False)', 'Line((2,11), (2,14), arrow = False, solid = True)'])
groundTruth['drawings/expert-34.png'] = set(['Line((5,13), (5,15), arrow = False, solid = True)', 'Line((4,12), (6,12), arrow = False, solid = True)', 'Line((6,13), (8,13), arrow = False, solid = True)', 'Line((7,10), (9,10), arrow = False, solid = True)', 'Line((3,15), (5,15), arrow = False, solid = True)', 'Line((4,12), (4,14), arrow = False, solid = True)', 'Line((7,10), (7,12), arrow = False, solid = True)', 'Line((8,11), (8,13), arrow = False, solid = True)'])
...
groundTruth['drawings/expert-53.png'] = set(['Line((2,14), (10,14), arrow = False, solid = True)', 'Line((6,14), (6,6), arrow = True, solid = True)', 'Line((8,14), (8,10), arrow = True, solid = True)', 'Line((4,14), (4,12), arrow = True, solid = True)'])
...
groundTruth['drawings/expert-9.png'] = set(['Line((7,14), (1,14), arrow = True, solid = True)'])
groundTruth['drawings/expert-18.png'] = set(['Circle(center = (6,13), radius = 1)', 'Circle(center = (9,11), radius = 1)', 'Circle(center = (5,11), radius = 1)', 'Circle(center = (3,14), radius = 1)', 'Circle(center = (9,9), radius = 1)', 'Circle(center = (7,9), radius = 1)'])
groundTruth['drawings/expert-20.png'] = set(['Circle(center = (3,10), radius = 1)', 'Line((10,14), (8,14), arrow = True, solid = True)', 'Circle(center = (11,10), radius = 1)', 'Circle(center = (7,10), radius = 1)', 'Line((6,14), (4,14), arrow = True, solid = True)', 'Circle(center = (11,14), radius = 1)', 'Line((3,13), (3,11), arrow = True, solid = True)', 'Circle(center = (7,14), radius = 1)', 'Line((7,13), (7,11), arrow = True, solid = True)', 'Line((11,13), (11,11), arrow = True, solid = True)', 'Rectangle((2,13), (4,15))'])
groundTruth['drawings/expert-25.png'] = set(['Line((10,11), (9,11), arrow = True, solid = True)', 'Rectangle((7,10), (9,12))', 'Rectangle((4,10), (6,12))', 'Line((7,11), (6,11), arrow = True, solid = True)', 'Rectangle((10,10), (12,12))'])
groundTruth['drawings/expert-27.png'] = set(['Line((4,13), (5,12), arrow = False, solid = True)', 'Line((3,12), (4,13), arrow = False, solid = True)', 'Line((4,11), (5,12), arrow = False, solid = True)', 'Line((3,12), (4,11), arrow = False, solid = True)'])
groundTruth['drawings/expert-30.png'] = set(['Circle(center = (6,12), radius = 1)', 'Rectangle((5,11), (7,15))', 'Rectangle((1,13), (3,15))', 'Circle(center = (2,14), radius = 1)', 'Circle(center = (2,11), radius = 1)', 'Circle(center = (6,14), radius = 1)', 'Rectangle((1,10), (3,12))'])
groundTruth['drawings/expert-32.png'] = set(['Rectangle((2,9), (7,12))', 'Circle(center = (7,14), radius = 1)', 'Line((4,14), (6,14), arrow = False, solid = True)', 'Rectangle((2,13), (4,15))'])
groundTruth['drawings/expert-38.png'] = set(['Circle(center = (5,8), radius = 1)', 'Circle(center = (2,8), radius = 1)', 'Circle(center = (8,11), radius = 1)', 'Line((2,9), (2,10), arrow = False, solid = True)', 'Circle(center = (8,8), radius = 1)', 'Line((8,9), (8,10), arrow = False, solid = True)', 'Line((5,12), (5,13), arrow = False, solid = True)', 'Line((2,12), (2,13), arrow = False, solid = True)', 'Line((3,8), (4,8), arrow = False, solid = True)', 'Circle(center = (5,14), radius = 1)', 'Line((5,9), (5,10), arrow = False, solid = True)', 'Circle(center = (2,14), radius = 1)', 'Circle(center = (2,11), radius = 1)', 'Circle(center = (8,14), radius = 1)', 'Circle(center = (5,11), radius = 1)', 'Line((6,11), (7,11), arrow = False, solid = True)', 'Line((3,14), (4,14), arrow = False, solid = True)', 'Line((6,8), (7,8), arrow = False, solid = True)', 'Line((8,12), (8,13), arrow = False, solid = True)', 'Line((6,14), (7,14), arrow = False, solid = True)', 'Line((3,11), (4,11), arrow = False, solid = True)'])
groundTruth['drawings/expert-39.png'] = set(['Line((6,8), (7,8), arrow = False, solid = True)', 'Line((3,8), (4,8), arrow = False, solid = True)', 'Rectangle((4,7), (6,9))', 'Rectangle((4,10), (6,12))', 'Line((3,11), (4,11), arrow = False, solid = True)', 'Line((8,9), (8,10), arrow = False, solid = True)', 'Rectangle((7,10), (9,12))', 'Rectangle((4,13), (6,15))', 'Line((5,9), (5,10), arrow = False, solid = True)', 'Line((6,14), (7,14), arrow = False, solid = True)', 'Line((5,12), (5,13), arrow = False, solid = True)', 'Line((6,11), (7,11), arrow = False, solid = True)', 'Rectangle((7,7), (9,9))', 'Rectangle((1,7), (3,9))', 'Line((2,12), (2,13), arrow = False, solid = True)', 'Rectangle((1,10), (3,12))', 'Line((3,14), (4,14), arrow = False, solid = True)', 'Line((2,9), (2,10), arrow = False, solid = True)', 'Rectangle((1,13), (3,15))', 'Line((8,12), (8,13), arrow = False, solid = True)', 'Rectangle((7,13), (9,15))'])
groundTruth['drawings/expert-46.png'] = set(['Line((10,9), (10,12), arrow = False, solid = True)', 'Circle(center = (3,7), radius = 1)', 'Line((5,14), (8,14), arrow = False, solid = True)', 'Circle(center = (10,14), radius = 1)', 'Line((3,9), (3,12), arrow = False, solid = True)', 'Circle(center = (3,14), radius = 1)', 'Line((5,7), (8,7), arrow = False, solid = True)', 'Circle(center = (10,7), radius = 1)'])
groundTruth['drawings/expert-48.png'] = set(['Line((2,15), (4,15), arrow = False, solid = True)', 'Line((5,12), (7,12), arrow = False, solid = True)', 'Line((4,13), (6,13), arrow = False, solid = True)', 'Line((7,10), (9,10), arrow = False, solid = True)', 'Line((6,11), (8,11), arrow = False, solid = True)', 'Line((3,14), (5,14), arrow = False, solid = True)'])
groundTruth['drawings/expert-49.png'] = set(['Rectangle((6,5), (8,6))', 'Rectangle((9,4), (11,6))', 'Rectangle((2,11), (5,14))', 'Rectangle((3,8), (4,10))', 'Rectangle((2,4), (5,7))'])
groundTruth['drawings/expert-52.png'] = set(['Line((5,13), (2,10), arrow = True, solid = True)', 'Circle(center = (5,9), radius = 1)', 'Line((5,13), (8,10), arrow = True, solid = True)', 'Line((2,8), (2,6), arrow = True, solid = True)', 'Circle(center = (5,14), radius = 1)', 'Circle(center = (2,9), radius = 1)', 'Circle(center = (8,5), radius = 1)', 'Circle(center = (8,9), radius = 1)', 'Line((5,13), (5,10), arrow = True, solid = True)', 'Line((8,8), (8,6), arrow = True, solid = True)', 'Circle(center = (5,5), radius = 1)', 'Line((5,8), (5,6), arrow = True, solid = True)', 'Circle(center = (2,5), radius = 1)'])
groundTruth['drawings/expert-54.png'] = set(['Line((6,11), (6,13), arrow = False, solid = True)', 'Rectangle((4,8), (8,15))', 'Rectangle((5,9), (7,11))', 'Rectangle((5,13), (7,15))'])
groundTruth['drawings/expert-56.png'] = set(['Circle(center = (2,7), radius = 1)', 'Circle(center = (6,12), radius = 1)', 'Circle(center = (2,12), radius = 1)', 'Circle(center = (6,10), radius = 1)', 'Circle(center = (6,7), radius = 1)', 'Circle(center = (2,14), radius = 1)', 'Rectangle((1,6), (7,8))', 'Rectangle((1,9), (3,15))', 'Circle(center = (6,14), radius = 1)', 'Rectangle((5,9), (7,15))', 'Circle(center = (2,10), radius = 1)', 'Circle(center = (4,7), radius = 1)'])
groundTruth['drawings/expert-61.png'] = set(['Circle(center = (4,10), radius = 1)', 'Line((7,10), (5,10), arrow = True, solid = True)', 'Circle(center = (8,10), radius = 1)', 'Rectangle((2,9), (9,11))'])
groundTruth['drawings/expert-70.png'] = set(['Line((2,9), (4,7), arrow = True, solid = True)', 'Circle(center = (6,10), radius = 1)', 'Line((6,13), (6,11), arrow = True, solid = True)', 'Circle(center = (2,14), radius = 1)', 'Circle(center = (4,6), radius = 1)', 'Circle(center = (6,14), radius = 1)', 'Line((2,13), (5,10), arrow = True, solid = True)', 'Line((6,9), (4,7), arrow = True, solid = True)', 'Circle(center = (2,10), radius = 1)', 'Line((6,13), (3,10), arrow = True, solid = True)', 'Line((2,13), (2,11), arrow = True, solid = True)'])
groundTruth['drawings/expert-71.png'] = set(['Rectangle((6,14), (10,15))', 'Line((8,6), (13,8), arrow = True, solid = True)', 'Line((10,14), (11,10), arrow = True, solid = True)', 'Line((5,14), (11,10), arrow = True, solid = True)', 'Line((8,6), (8,8), arrow = True, solid = True)', 'Rectangle((3,5), (13,6))', 'Rectangle((1,8), (5,10))', 'Rectangle((6,8), (10,10))', 'Line((8,10), (8,14), arrow = True, solid = True)', 'Line((5,14), (6,10), arrow = True, solid = True)', 'Rectangle((1,14), (5,15))', 'Line((8,6), (3,8), arrow = True, solid = True)', 'Line((3,10), (3,14), arrow = True, solid = True)', 'Rectangle((11,8), (15,10))', 'Rectangle((11,14), (15,15))', 'Line((13,10), (13,14), arrow = True, solid = True)'])
groundTruth['drawings/expert-72.png'] = set(['Circle(center = (2,8), radius = 1)', 'Rectangle((6,9), (7,10))', 'Circle(center = (8,8), radius = 1)', 'Rectangle((6,12), (7,13))', 'Rectangle((3,9), (4,10))', 'Circle(center = (2,14), radius = 1)', 'Circle(center = (8,14), radius = 1)', 'Circle(center = (5,11), radius = 1)', 'Rectangle((3,12), (4,13))'])
groundTruth['drawings/expert-73.png'] = set(['Rectangle((9,13), (11,15))', 'Line((14,7), (14,9), arrow = True, solid = True)', 'Rectangle((13,13), (15,15))', 'Line((11,14), (13,10), arrow = True, solid = True)', 'Rectangle((5,9), (7,11))', 'Line((14,11), (14,13), arrow = True, solid = True)', 'Rectangle((5,13), (7,15))', 'Rectangle((9,9), (11,11))', 'Line((3,7), (14,7), arrow = False, solid = True)', 'Line((6,11), (6,13), arrow = True, solid = True)', 'Line((7,14), (9,10), arrow = True, solid = True)', 'Line((10,7), (10,9), arrow = True, solid = True)', 'Line((6,7), (6,9), arrow = True, solid = True)', 'Line((10,11), (10,13), arrow = True, solid = True)', 'Rectangle((13,9), (15,11))', 'Rectangle((1,6), (3,14))'])
groundTruth['drawings/expert-74.png'] = set(['Circle(center = (6,12), radius = 1)', 'Circle(center = (2,12), radius = 1)', 'Circle(center = (6,10), radius = 1)', 'Circle(center = (4,14), radius = 1)', 'Rectangle((3,11), (5,13))', 'Circle(center = (2,14), radius = 1)', 'Circle(center = (4,10), radius = 1)', 'Circle(center = (6,14), radius = 1)', 'Rectangle((1,9), (7,15))', 'Circle(center = (4,12), radius = 1)', 'Circle(center = (2,10), radius = 1)'])
groundTruth['drawings/expert-75.png'] = set(['Circle(center = (2,14), radius = 1)', 'Circle(center = (10,10), radius = 1)', 'Line((10,13), (10,11), arrow = True, solid = True)', 'Line((7,14), (9,14), arrow = True, solid = True)', 'Circle(center = (6,10), radius = 1)', 'Circle(center = (14,14), radius = 1)', 'Line((11,14), (13,14), arrow = True, solid = True)', 'Line((3,14), (5,14), arrow = True, solid = True)', 'Circle(center = (10,14), radius = 1)', 'Circle(center = (14,10), radius = 1)', 'Circle(center = (6,14), radius = 1)', 'Line((6,13), (6,11), arrow = True, solid = True)', 'Circle(center = (2,10), radius = 1)', 'Line((14,13), (14,11), arrow = True, solid = True)', 'Line((2,13), (2,11), arrow = True, solid = True)'])
groundTruth['drawings/expert-76.png'] = set(['Circle(center = (6,6), radius = 1)', 'Line((6,10), (10,7), arrow = False, solid = True)', 'Line((6,10), (6,15), arrow = False, solid = True)', 'Circle(center = (9,13), radius = 1)', 'Line((2,7), (6,10), arrow = False, solid = True)', 'Circle(center = (3,13), radius = 1)'])
groundTruth['drawings/expert-77.png'] = set(['Circle(center = (10,14), radius = 1)', 'Line((2,9), (5,7), arrow = False, solid = True)', 'Rectangle((5,13), (7,15))', 'Line((10,11), (10,13), arrow = False, solid = True)', 'Circle(center = (6,7), radius = 1)', 'Rectangle((9,9), (11,11))', 'Circle(center = (2,14), radius = 1)', 'Line((7,14), (9,14), arrow = False, solid = True)', 'Line((2,11), (2,13), arrow = False, solid = True)', 'Line((3,14), (5,14), arrow = False, solid = True)', 'Line((7,7), (10,9), arrow = False, solid = True)', 'Rectangle((1,9), (3,11))'])
groundTruth['drawings/expert-78.png'] = set(['Line((4,9), (6,11), arrow = True, solid = True)', 'Line((7,13), (7,12), arrow = True, solid = True)', 'Line((1,13), (13,13), arrow = False, solid = True)', 'Line((9,10), (8,11), arrow = True, solid = True)', 'Line((1,15), (9,7), arrow = False, solid = True)', 'Line((5,7), (13,15), arrow = False, solid = True)'])
groundTruth['drawings/expert-79.png'] = set(['Line((7,5), (7,3), arrow = True, solid = True)', 'Circle(center = (3,10), radius = 1)', 'Circle(center = (7,6), radius = 1)', 'Line((7,9), (7,7), arrow = True, solid = True)', 'Line((11,9), (8,6), arrow = True, solid = True)', 'Circle(center = (11,14), radius = 1)', 'Circle(center = (11,10), radius = 1)', 'Circle(center = (7,10), radius = 1)', 'Line((3,13), (3,11), arrow = True, solid = True)', 'Line((11,13), (11,11), arrow = True, solid = True)', 'Circle(center = (3,14), radius = 1)', 'Circle(center = (7,2), radius = 1)', 'Circle(center = (7,14), radius = 1)', 'Line((3,9), (6,6), arrow = True, solid = True)', 'Line((7,13), (7,11), arrow = True, solid = True)'])
groundTruth['drawings/expert-80.png'] = set(['Circle(center = (10,14), radius = 1)', 'Circle(center = (4,5), radius = 1)', 'Circle(center = (10,8), radius = 1)', 'Circle(center = (14,8), radius = 1)', 'Circle(center = (2,8), radius = 1)', 'Circle(center = (6,14), radius = 1)', 'Line((6,7), (4,6), arrow = True, solid = True)', 'Circle(center = (8,2), radius = 1)', 'Circle(center = (12,11), radius = 1)', 'Circle(center = (6,8), radius = 1)', 'Line((12,10), (10,9), arrow = True, solid = True)', 'Line((14,7), (12,6), arrow = True, solid = True)', 'Line((2,7), (4,6), arrow = True, solid = True)', 'Line((12,10), (14,9), arrow = True, solid = True)', 'Line((11,11), (6,9), arrow = True, solid = True)', 'Line((4,10), (6,9), arrow = True, solid = True)', 'Circle(center = (4,11), radius = 1)', 'Line((12,4), (8,3), arrow = True, solid = True)', 'Circle(center = (12,5), radius = 1)', 'Line((5,11), (10,9), arrow = True, solid = True)', 'Circle(center = (2,14), radius = 1)', 'Line((4,10), (2,9), arrow = True, solid = True)', 'Line((6,13), (4,12), arrow = True, solid = True)', 'Circle(center = (14,14), radius = 1)', 'Line((4,4), (8,3), arrow = True, solid = True)', 'Line((14,13), (12,12), arrow = True, solid = True)', 'Line((2,13), (4,12), arrow = True, solid = True)', 'Line((10,7), (12,6), arrow = True, solid = True)', 'Line((10,13), (12,12), arrow = True, solid = True)'])
groundTruth['drawings/expert-81.png'] = set(['Circle(center = (2,14), radius = 1)', 'Circle(center = (5,14), radius = 1)', 'Rectangle((10,13), (12,15))', 'Rectangle((7,13), (9,15))'])
groundTruth['drawings/expert-82.png'] = set(['Circle(center = (11,8), radius = 1)', 'Line((9,14), (10,14), arrow = True, solid = True)', 'Circle(center = (2,14), radius = 1)', 'Line((8,7), (8,6), arrow = True, solid = True)', 'Circle(center = (2,8), radius = 1)', 'Circle(center = (8,11), radius = 1)', 'Line((12,8), (14,10), arrow = True, solid = True)', 'Line((9,11), (10,11), arrow = True, solid = True)', 'Circle(center = (8,5), radius = 1)', 'Circle(center = (11,11), radius = 1)', 'Line((8,13), (8,12), arrow = True, solid = True)', 'Line((2,7), (2,6), arrow = True, solid = True)', 'Circle(center = (2,5), radius = 1)', 'Line((4,9), (6,9), arrow = True, solid = True)', 'Line((12,11), (13,11), arrow = True, solid = True)', 'Line((12,14), (13,14), arrow = True, solid = True)', 'Line((14,12), (14,13), arrow = True, solid = True)', 'Circle(center = (2,11), radius = 1)', 'Line((2,10), (2,9), arrow = True, solid = True)', 'Circle(center = (8,8), radius = 1)', 'Circle(center = (14,11), radius = 1)', 'Line((2,13), (2,12), arrow = True, solid = True)', 'Circle(center = (8,14), radius = 1)', 'Line((8,10), (8,9), arrow = True, solid = True)', 'Circle(center = (11,14), radius = 1)', 'Line((9,8), (10,8), arrow = True, solid = True)', 'Circle(center = (14,14), radius = 1)'])
groundTruth['drawings/expert-83.png'] = set(['Circle(center = (9,11), radius = 1)', 'Line((4,13), (3,12), arrow = True, solid = True)', 'Circle(center = (2,14), radius = 1)', 'Line((2,13), (3,12), arrow = True, solid = True)', 'Circle(center = (4,14), radius = 1)', 'Line((8,13), (9,12), arrow = True, solid = True)', 'Circle(center = (10,14), radius = 1)', 'Circle(center = (8,14), radius = 1)', 'Line((9,10), (6,9), arrow = True, solid = True)', 'Circle(center = (3,11), radius = 1)', 'Circle(center = (6,8), radius = 1)', 'Line((10,13), (9,12), arrow = True, solid = True)', 'Line((3,10), (6,9), arrow = True, solid = True)'])
groundTruth['drawings/expert-84.png'] = set(['Circle(center = (2,14), radius = 1)', 'Line((7,8), (8,8), arrow = True, solid = True)', 'Line((7,11), (8,11), arrow = True, solid = True)', 'Line((2,13), (2,12), arrow = True, solid = True)', 'Circle(center = (2,8), radius = 1)', 'Line((10,11), (11,11), arrow = True, solid = True)', 'Circle(center = (6,11), radius = 1)', 'Line((7,14), (8,14), arrow = True, solid = True)', 'Circle(center = (9,14), radius = 1)', 'Circle(center = (6,14), radius = 1)', 'Line((2,7), (2,6), arrow = True, solid = True)', 'Circle(center = (2,5), radius = 1)', 'Circle(center = (12,14), radius = 1)', 'Circle(center = (12,11), radius = 1)', 'Line((6,13), (6,12), arrow = True, solid = True)', 'Line((10,8), (12,10), arrow = True, solid = True)', 'Line((12,12), (12,13), arrow = True, solid = True)', 'Circle(center = (2,11), radius = 1)', 'Line((2,10), (2,9), arrow = True, solid = True)', 'Circle(center = (6,5), radius = 1)', 'Line((6,7), (6,6), arrow = True, solid = True)', 'Line((6,10), (6,9), arrow = True, solid = True)', 'Circle(center = (9,8), radius = 1)', 'Circle(center = (9,11), radius = 1)', 'Circle(center = (6,8), radius = 1)', 'Line((10,14), (11,14), arrow = True, solid = True)'])
groundTruth['drawings/expert-85.png'] = set(['Line((3,13), (3,12), arrow = True, solid = True)', 'Circle(center = (3,14), radius = 1)', 'Line((3,7), (3,6), arrow = True, solid = True)', 'Circle(center = (3,11), radius = 1)', 'Line((3,10), (3,9), arrow = True, solid = True)', 'Circle(center = (3,5), radius = 1)', 'Circle(center = (3,8), radius = 1)'])
groundTruth['drawings/expert-86.png'] = set(['Rectangle((7,11), (9,13))', 'Rectangle((6,7), (9,10))', 'Rectangle((1,7), (2,8))', 'Rectangle((1,12), (4,15))', 'Rectangle((8,14), (9,15))', 'Rectangle((1,9), (3,11))'])
groundTruth['drawings/expert-87.png'] = set(['Rectangle((8,7), (9,8))', 'Rectangle((7,9), (9,11))', 'Rectangle((1,7), (2,8))', 'Rectangle((1,12), (4,15))', 'Rectangle((6,12), (9,15))', 'Rectangle((1,9), (3,11))'])
